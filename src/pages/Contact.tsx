          ...
          <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
              ...
              <h1 className="font-display text-4xl md:text-5xl font-bold text-foreground mb-6">
                <AnimatedText text="Contact" delay={0.3} />
              </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              >
                {[
                  ...
                  >
                    <label className="font-body text-xs tracking-widest uppercase text-muted-foreground mb-2 block">{field.label}</label>
                    <Input
                      type={field.type}
                      value={form[field.key as keyof typeof form]}
                      onChange={(e) => setForm({ ...form, [field.key]: e.target.value })}
                      required
                      className="bg-card border-border focus:border-gold transition-all duration-300 focus:shadow-lg focus:shadow-gold/10"
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}>
                  ...
                  <Textarea
                    ...
                    required
                    rows={5}
                    className="bg-card border-border focus:border-gold resize-none transition-all duration-300 focus:shadow-lg focus:shadow-gold/10"
                    placeholder="Votre message..."
                  />
                </motion.div>
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Button type="submit" className="w-full gradient-gold text-background font-body text-sm tracking-widest uppercase hover:opacity-90 shadow-lg shadow-gold/20">
              ...
              >
                {[
                  {
                    title: "WhatsApp",
                    desc: "Contactez-nous directement sur WhatsApp pour une réponse rapide.",
                    href: "https://wa.me/33623413595",
                    icon: <MessageCircle className="w-4 h-4" />,
                    label: "+33 6 23 41 35 95",
                  },
                  {
                    title: "Instagram",
                    desc: "Suivez-nous pour découvrir nos dernières créations.",
                  ...
                  >
                    <h3 className="font-display text-lg text-gold mb-4">{item.title}</h3>
                    <p className="font-elegant text-foreground/70 mb-4">{item.desc}</p>
                    <motion.a
                      href={item.href}
                      target="_blank"
                ...
                <motion.div
                  ...
                  className="bg-card border border-border p-8 rounded-sm hover:border-gold/30 transition-all duration-500"
                >
